...
function generateSpiralMatrix(n) {
  ...
  while (left <= right && top <= bottom) {
    if (direction === 0) {
      // keep top same, move from left to right, increment top
    ...
    if (direction === 1) {
      // keep right same, move from top to bottom, decrement right
    ...
    if (direction === 2) {
      // keep bottom same, move from right to left, decrement bottom
    ...
    if (direction === 3) {
      // keep left same, move from bottom to top, increment left
