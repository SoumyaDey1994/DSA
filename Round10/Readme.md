...
#### 13/03/2026
1. Word Break
2. House Robber (House Thief)
3. Merge Intervals
4. Function Curry
5. Function toString Formatter
6. Peak Element

#### 14/03/2026
7. House Painting Problem
8. Find smallest deviation in a list
9. Custom DS with O(1) complexity - No Duplicate Entries
10. Longest Substring with Unique Characters
11. Longest Palindromic Substring
12. Rotate Matrix k times
13. Coin Change – Number of Ways
...
18. Two Sum
19. Two Sum II – Input Array is Sorted: Given a sorted array, find two numbers such that they add up to a specific target. Return their indices
