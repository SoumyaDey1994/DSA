...
2. Burst Balloons - Interval DP — maximize coins by choosing optimal balloon burst order.
...
(Trie version exists, but you can do it with pure DFS too — just slower)
