 ...
 *      output: [4, 7]
 */
function getTopKFrequentElements(nums, k) {
  ...
  let numFreqList = Array.from(freqMap.entries());
  // Sort against frequency DESC order
  numFreqList = numFreqList.sort((pair1, pair2) => pair2[1] - pair1[1]);
...
let nums = [1, 1, 1, 2, 2, 3],
  k = 2;
console.log(
  `${k} most frequent element of [${nums}] are: [${getTopKFrequentElements(
    nums,
    k,
  )}]`,
);
