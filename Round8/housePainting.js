...
function findWaysToPaintHouses(noOfHouses, noOfColors, firstColor, lastColor) {
  ...
  ways = findWays(2, noOfHouses, noOfColors, prevColor, lastColor); // currHouse, noOfHouses, noOfColors, prevColor, lastColor
  return ways;
}

function findWays(currHouse, noOfHouses, noOfColors, prevColor, lastColor) {
  ...
  for (let i = 1; i <= noOfColors; i++) {
    if (i !== prevColor) {
      ways =
        ways + findWays(currHouse + 1, noOfHouses, noOfColors, i, lastColor);
    }
  }
