...
class MyDataStructure {
  ...
  delete(item) {
    ...
    if (itemIndex) {
      ...
      //   console.log("Last Item: ", lastItem, lastIndex);
      this.list[itemIndex] = this.list[lastIndex]; // swap

      this.indexMap.set(lastItem, itemIndex); // reset position of last item in indexMap
      this.list.pop();
