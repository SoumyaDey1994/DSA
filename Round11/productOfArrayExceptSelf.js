 ...
 */
function findProductOfArrayExceptSelf(nums) {
...
let nums = [1, 2, 3, 4]; // [1, 1, 2, 6] ==> [1*24, 1*12, 2*4, 6*1] ==> [24, 12, 8, 6]
console.log(
  `Product of Array [${nums}] becomes: [${findProductOfArrayExceptSelf(nums)}]`,
);
