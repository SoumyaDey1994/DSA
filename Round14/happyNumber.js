...
function isHappyNumber(num) {
  ...
  let low = findSquareSumOfDigits(num);
  let high = findSquareSumOfDigits(findSquareSumOfDigits(num));

  while (high !== 1 && low !== high) {
    low = findSquareSumOfDigits(low);
    high = findSquareSumOfDigits(findSquareSumOfDigits(high));
  }
