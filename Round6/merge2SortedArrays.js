...
function mergeSortedArrays(num1, m, num2, n) {
  let maxIndex = m + n - 1;
  let num1MaxIndex = m - 1;
  let num2MaxIndex = n - 1;

  while (num1MaxIndex >= 0 && num2MaxIndex >= 0) {
    if (num1[num1MaxIndex] > num2[num2MaxIndex]) {
      num1[maxIndex] = num1[num1MaxIndex];
      num1MaxIndex--;
    } else {
      num1[maxIndex] = num2[num2MaxIndex];
      num2MaxIndex--;
    }
    maxIndex--;
  }
  ...
  if (num2MaxIndex >= 0) {
    num1[num2MaxIndex] = num2[num2MaxIndex];
    num2MaxIndex--;
    maxIndex--;
  }
