...
function canWordSegmented(str, words) {
  if (!str || str.length === 0 || words.length === 0) return;
...
let str = "leetcode",
  words = ["leet", "code"];
console.log(
  `${str} can be segmented into [${words}]: ${canWordSegmented(str, words)}`
);
...
str = "cars";
wordList = ["car", "ca", "rs"];
output = canWordSegmented(str, wordList);
