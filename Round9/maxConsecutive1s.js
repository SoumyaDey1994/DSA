 ...
 * Our task is to find the maximum number of consecutive 1s.
 * You can get in the array after performing at most k flips.
 * Example 1:
 ...
 */
function findMaxConsecutive1s(input, k) {
