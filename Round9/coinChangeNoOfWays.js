...
function findNoOfWaysToGetChange(coins, amount) {
  ...
  function findWays(start, remaining, memo = new Map()) {
    ...
    const waysWithCurrentCoin = findWays(start, remaining - coins[start]);
    const waysWithoutCurrentCoin = findWays(start + 1, remaining);
